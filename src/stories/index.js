        ...
        [
          {
            'type': 'SpiralChart',
            'data': {
              'dataFile': "data/temperature.csv",
              'fileType': 'csv',
              'fieldDesc': [['Year', 'date', 'YYYY'], ['Jan', 'number'], ['Feb', 'number'], ['Mar', 'number'], ['Apr', 'number'], ['May', 'number'], ['Jun', 'number'], ['Jul', 'number'], ['Aug', 'number'], ['Sep', 'number'], ['Oct', 'number'], ['Nov', 'number'], ['Dec', 'number'], ['AveragYear', 'number']]
            },
            'style': {
              'origin': [0, 0, 0],
              'width': 5,
